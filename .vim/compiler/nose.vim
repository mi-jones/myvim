...
" Compiler: Unit testing tool for Python using nose in vim
" Maintained: Michael Jones
...
" this version will add the full tracebacks in the VIM quickfix window
" obtained from https://bitbucket.org/tartlet/vim_run_python_tests
